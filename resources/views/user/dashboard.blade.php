    ...
    <section id="main" class="pt-[48px] lg:pt-[80px] w-full h-[calc(100vh-48px)] lg:h-[calc(100vh-80px)]">
        <div id="grid" class="lg:grid lg:grid-cols-8">
            <div id="sidenav" class="fixed lg:static lg:col-start-1 lg:col-span-1 h-[calc(100vh-48px)] lg:h-[calc(100vh-80px)] lg:left-0 left-[-300px] bg-[#04BF68] shadow text-black font-medium">
                <div class="pt-4"> 
                    <div id="home" class="px-5 py-2 flex lg:hidden items-center duration-300 cursor-pointer hover:bg-white hover:bg-opacity-70" onclick="EnableDashboard()">
                    ...
                    <div id="medical-files" class="px-5 py-2 flex items-center duration-300 cursor-pointer hover:bg-white hover:bg-opacity-70" onclick="EnableMedicalFiles()">
                        <i class="bi bi-file-earmark-text-fill"></i>
                        <span class="mx-2 my-[4px] text-sm text-black">Receitas</span>
                    </div>
                    <div id="documents" class="px-5 py-2 flex items-center duration-300 cursor-pointer hover:bg-white hover:bg-opacity-70" onclick="EnableDocuments()">
