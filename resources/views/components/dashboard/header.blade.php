        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="{{ route('index') }}" class="flex items-center justify-between mr-4">
                    <img src="{{ asset('img/logo_marijuana.png') }}" class="mr-3 h-8" alt="Marijuana Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Marijuana</span>
                </a>
            </div>
            <div class="flex items-center lg:order-2">
                ...
                <button type="button" data-dropdown-toggle="notification-dropdown"
                    ...
                    <span class="sr-only">Exibir notificações</span>
                    <!-- Bell icon -->
                    <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                    ...
                    <div class="py-3 px-4">
                        ...
                        <span class="block text-sm text-gray-900 truncate dark:text-white">name@company.com</span>
                    </div>
                    <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                        <li>
                            <a href="#"
                                class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Meu
                                Perfil</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">
                                Configurações de conta</a>
                        </li>
                    </ul>
                    <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                        <li>
