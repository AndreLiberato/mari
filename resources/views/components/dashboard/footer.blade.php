<footer
    class="lg:fixed bottom-0 right-0 left-0 bg-white shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 md:ml-64 dark:bg-gray-800">
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2023
        <a href="{{ route('index') }}" class="hover:underline" target="_blank">Marijuana</a>. Todos os direitos reservados.
    </p>
